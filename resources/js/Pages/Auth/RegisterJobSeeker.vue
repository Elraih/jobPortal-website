  ...
  <section class="min-h-screen flex items-center">
    <div class="max-w-5xl w-full mx-auto px-4 py-8">
      ...
      <div class="text-white flex justify-between items-center pb-7">
        ...
        <Link :href="route('auth.registerAsCompany')"
      ...
      <div class="grid lg:grid-cols-2 gap-10">
        ...
        <form class="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="first_name" placeholder="John"
                class="w-full p-2.5 rounded-lg border border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500"
                required>
            </div>
            <div>
          ...
          <div class="mt-6 text-sm text-center text-gray-600 space-y-2">
            ...
            <p>
              Are you a company?
              <Link :href="route('auth.registerAsCompany')" class="text-blue-600 hover:underline ml-1">Register as a
              company</Link>
            </p>
